...
악기를 잘 다루는 것
기타 연주나 지판의 이해처럼 복잡한 것을 예측하며 능숙하게 다룰 때 
...
모호했던 것들을 명료하게 볼 수 있거나 개념은 모르지만 말이나 동작으로 수행하거나 느끼는 것
예)
특정한 어구를 사용할 수 있게 되는 것
외국어의 어구를 사용할 수 있게 되는 것
수영을 하며 발차기하는 느낌을 알게 되는 것
프로그래밍의 여러가지 모호했던 개념들이 연결되는 듯 느껴지는 것
내가 어떤 것들을 어느정도 설명할 수 있게 되는 것
